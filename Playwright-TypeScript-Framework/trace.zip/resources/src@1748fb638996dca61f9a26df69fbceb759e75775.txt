import { Page, Locator, FrameLocator, FileChooser, Download } from "@playwright/test";
...
export class BasePage {
    ...
    /**
 * It is used to accept JavaScript Alert dialog.
 */
    ...
    /**
     * It is used to dismiss JavaScript Alert/Confirmation dialog.
     */
    ...
    /**
     * It is used to accept Prompt dialog with the given input text.
     * @param text
     */
    ...
    /**
     * It is used to scroll the page by the given X and Y coordinates.
     * @param x
     * @param y
     */
    ...
    /**
     * It is used to scroll the page until the specified element is visible.
     * @param element
     */
    ...
    /**
     * It is used to scroll the page using mouse wheel movement.
     * @param deltaX
     * @param deltaY
     */
    ...
    /**
     * It is used to release the mouse button.
     */
    async scrollUp() {
    ...
    /**
     * It is used to press the mouse button.
     */
    async scrollDown() {
    ...
    /**
     * It is used to switch to a browser window by its index.
     * @param index
     * @returns Page
     */
    ...
    /**
     * It is used to switch to a browser window by matching its URL.
     * @param expUrl
     * @returns Page
     */
    async switchOnNewWindowByUrl(expUrl: string): Promise<Page> {
    ...
    /**
     * It is used to switch to a browser window by matching its title.
     * @param expTitle
     * @returns Page
     */
    async switchOnNewWindowByTitle(expTitle: string): Promise<Page> {
        const pages = this.page.context().pages();
        for (const p of pages) {
    ...
    /**
     * It is used to get the total number of opened browser windows/tabs.
     * @returns number
     */
    ...
    /**
    * It is used to upload multiple files
    * @param element 
    * @param filePath 
    */
    async upLoadFiles(element: Locator, filePath: string[]) {
        await element.setInputFiles(filePath);
    }

    /**
     * It is used when setInputFiles() will not work then this will be used.
     * @param element 
     * @param filePath 
     */
    async clickAndUploadFile(element: Locator, filePath: string) {
        let waitForFileUploadChooser: Promise<FileChooser> = this.page.waitForEvent("filechooser");
        await element.click();
        let fileChooser: FileChooser = await waitForFileUploadChooser;
     ...
     * @param filePath 
     */
    async downloadFile(element: Locator, filePath: string) {
        let waitForFileDownload: Promise<Download> = this.page.waitForEvent("download");
        await element.click();
        let downloadFile: Download = await waitForFileDownload;
    ...
    /**
     * It is used to wait for element visvibility
     * @param element 
     */
    ...
    /**
     * It is used to wait for element invisvibility
     * @param element 
     */
    async waitForElementInvisibility(element: Locator) {
        await element.waitFor({ state: "hidden" });
    }


    /**
     * It is used to wait until the expected URL is loaded.
     * @param url
     */
    ...
    /**
     * It is used to wait until the page reaches the specified load state.
     * @param state
     */
    ...
    async waitForEvent(): Promise<Page> {
